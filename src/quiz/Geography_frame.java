...
public class Geography_frame extends ScoreboardJFrame {


	private JLabel lbl_q1;
    private JLabel lbl_question;
	private final static Integer qID = 10;
...
//	}
	 ...
	 * Create the frame. 
	 */
	public Geography_frame(ScoreboardService scoreboardService, User user) {
		...
		//ButtonGroup Initialization//
	     ...
	     next_btn.addMouseListener(new MouseAdapter() {
	     	...
	     	public void mouseClicked(MouseEvent e) {
				...
				dispose();
				Geo_fr2 frame1 = new Geo_fr2(scoreboardService, user);
