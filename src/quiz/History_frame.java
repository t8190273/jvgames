...
public class History_frame extends ScoreboardJFrame {


	private JLabel lbl_q1;
    private JLabel lbl_question;
	private final static Integer qID = 20;
...
//			public void run() {
//				try {
//					History_frame frame = new History_frame();
...
//	}
	 ...
	 * Create the frame. 
	 */
	public History_frame(ScoreboardService scoreboardService, User user) {
		...
		//ButtonGroup Initialization//
	     ...
	     next_btn.addMouseListener(new MouseAdapter() {
	     	...
	     	public void mouseClicked(MouseEvent e) {
				...
				dispose();
				Hist_fr2 frame1 = new Hist_fr2(scoreboardService, user);
