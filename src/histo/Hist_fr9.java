...
public class Hist_fr9 extends ScoreboardJFrame {

	private JLabel lbl_q1;
    private JLabel lbl_question;
	private final static Integer qID = 28;
...
//	}
	 ...
	 * Create the frame.
	 */
	public Hist_fr9(ScoreboardService scoreboardService, User user) {
		...
		//ButtonGroup Initialization//
	     ...
	     next_btn.addMouseListener(new MouseAdapter() {
	     	...
	     	public void mouseClicked(MouseEvent e) {
				...
				dispose();
				Hist_fr10 frame1 = new Hist_fr10(scoreboardService, user);
