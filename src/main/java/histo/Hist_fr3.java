...
public class Hist_fr3 extends ScoreboardJFrame {

	private JLabel lbl_q1;
    private JLabel lbl_question;
	private final static Integer qID = 22;
...
//	}
	 ...
	 * Create the frame.
	 */
	public Hist_fr3(ScoreboardService scoreboardService, User user) {
		...
		//ButtonGroup Initialization//
	     ...
	     next_btn.addMouseListener(new MouseAdapter() {
	     	...
	     	public void mouseClicked(MouseEvent e) {
				...
				dispose();
				Hist_fr4 frame1 = new Hist_fr4(scoreboardService, user);
