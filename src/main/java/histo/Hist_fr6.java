...
public class Hist_fr6 extends ScoreboardJFrame {

	private JLabel lbl_q1;
    private JLabel lbl_question;
	private final static Integer qID = 25;
	...
	//radio btn//
			...
			ButtonGroup bg;
			//apanthseis- sunolo 4//
			String ap1[] = {"\u03B1) \u03C4\u03BF 1927"}; /*Óùóôü*/
		    String ap2[] = {"\u03B2) \u03C4\u03BF 1928"};
		    String ap3[] = {"\u03B3) \u03C4\u03BF 1860"};
		    String ap4[] = {"\u03B4) \u03C4\u03BF 1841"};
...
//	}
	 ...
	 * Create the frame.
	 */
	public Hist_fr6(ScoreboardService scoreboardService, User user) {
		...
		//ButtonGroup Initialization//
	     ...
	     lbl_question = new JLabel("\u0397 \u03C4\u03C1\u03AC\u03C0\u03B5\u03B6\u03B1 \u03C4\u03B7\u03C2 \u0395\u03BB\u03BB\u03AC\u03B4\u03B1\u03C2 \u03B9\u03B4\u03C1\u03CD\u03B8\u03B7\u03BA\u03B5:");
	     ...
	     next_btn.addMouseListener(new MouseAdapter() {
	     	...
	     	public void mouseClicked(MouseEvent e) {
				...
				dispose();
				Hist_fr7 frame1 = new Hist_fr7(scoreboardService, user);
