...
public class Hist_fr10 extends ScoreboardJFrame {

	private JLabel lbl_q1;
    private JLabel lbl_question;
	private final static Integer qID = 29;
...
//	}
	 ...
	 * Create the frame.
	 */
	public Hist_fr10(ScoreboardService scoreboardService, User user) {
		...
		//ButtonGroup Initialization//
	     ...
	     next_btn.addMouseListener(new MouseAdapter() {
	     	...
	     	public void mouseClicked(MouseEvent e) {
				...
				dispose();
				Hist_final frame1 = new Hist_final(scoreboardService, user);
