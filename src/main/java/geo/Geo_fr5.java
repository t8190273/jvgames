...
public class Geo_fr5 extends ScoreboardJFrame {
	
	private JLabel lbl_q1;
    private JLabel lblNewLabel;
	private final static Integer qID = 14;
...
//	}
	 ...
	 * Create the frame.
	 */
	public Geo_fr5(ScoreboardService scoreboardService, User user) {
		...
		//ButtonGroup Initialization//
	     ...
	     next_btn.addMouseListener(new MouseAdapter() {
	     	...
	     	public void mouseClicked(MouseEvent e) {
				...
				dispose();
				Geo_fr6 frame1 = new Geo_fr6(scoreboardService, user);
