...
public class Geo_fr4 extends ScoreboardJFrame {

	private JLabel lbl_q1;
    private JLabel lblNewLabel;
	private final static Integer qID = 13;
...
//	}
	 ...
	 * Create the frame.
	 */
	public Geo_fr4(ScoreboardService scoreboardService, User user) {
		...
		//ButtonGroup Initialization//
	     ...
	     next_btn.addMouseListener(new MouseAdapter() {
	     	...
	     	public void mouseClicked(MouseEvent e) {
				...
				dispose();
				Geo_fr5 frame1 = new Geo_fr5(scoreboardService, user);
