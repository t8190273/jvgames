...
public class Geo_fr3 extends ScoreboardJFrame {

	private JLabel lbl_q1;
    private JLabel lblNewLabel;
	private final static Integer qID = 12;
	...
	//radio btn//
		...
		ButtonGroup bg;
		//apanthseis- sunolo 4//
		String ap1[] = {"\u03B1) \u03A4\u03C1\u03B9\u03C7\u03BF\u03BD\u03AF\u03B4\u03B1"}; /*Swsto*/
	    String ap2[] = {"\u03B2) \u0392\u03B9\u03C3\u03C4\u03C9\u03BD\u03AF\u03B4\u03B1"};
	    String ap3[] = {"\u03B3) \u03A0\u03B1\u03BC\u03B2\u03CE\u03C4\u03B9\u03B4\u03B1"}; 
	    String ap4[] = {"\u03B4) \u039A\u03B5\u03C1\u03BA\u03AF\u03BD\u03B7"};
...
//	}
	 ...
	 * Create the frame.
	 */
	public Geo_fr3(ScoreboardService scoreboardService, User user) {
		...
		//ButtonGroup Initialization//
	     ...
	     lblNewLabel = new JLabel("  \u0397 \u03BC\u03B5\u03B3\u03B1\u03BB\u03CD\u03C4\u03B5\u03C1\u03B7 \u03C3\u03B5 \u03B5\u03C0\u03B9\u03C6\u03AC\u03BD\u03B5\u03B9\u03B1 \u03BB\u03AF\u03BC\u03BD\u03B7 \u03C4\u03B7\u03C2 \u0395\u03BB\u03BB\u03AC\u03B4\u03BF\u03C2 \u03B5\u03AF\u03BD\u03B1\u03B9");
	     lblNewLabel.setFont(new Font("Comic Sans MS", Font.PLAIN, 23));
	     lblNewLabel.setForeground(new Color(0, 0, 102));
	     lblNewLabel.setBounds(38, 109, 763, 70);
	     ...
	     next_btn.addMouseListener(new MouseAdapter() {
	     	...
	     	public void mouseClicked(MouseEvent e) {
				...
				dispose();
				Geo_fr4 frame1 = new Geo_fr4(scoreboardService, user);
