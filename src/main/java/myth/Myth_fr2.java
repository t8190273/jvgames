...
public class Myth_fr2 extends ScoreboardJFrame {

	private JLabel lbl_q1;
    private JLabel lblNewLabel;
	private final static Integer qID = 31;
	...
	//radio btn//
		...
		ButtonGroup bg;
		//apanthseis- sunolo 4//
		String ap1[] = {"\u03B1) \u039A\u03AD\u03BD\u03C4\u03B1\u03C5\u03C1\u03BF\u03B9"}; /*Swsto*/
	    String ap2[] = {"\u03B2) \u03A3\u03B5\u03B9\u03C1\u03AE\u03BD\u03B5\u03C2"};
	    String ap3[] = {"\u03B3) \u03A3\u03AC\u03C4\u03B9\u03C1\u03B5\u03C2"};
	    String ap4[] = {"\u03B4) \u0393\u03AF\u03B3\u03B1\u03BD\u03C4\u03B5\u03C2"};
...
//	}
	 ...
	 * Create the frame.
	 */
	public Myth_fr2(ScoreboardService scoreboardService, User user) {
		...
		//ButtonGroup Initialization//
	     ...
	     lblNewLabel = new JLabel("\u03A4\u03B1 \u03C0\u03BB\u03AC\u03C3\u03BC\u03B1\u03C4\u03B1 \u03C0\u03BF\u03C5 \u03B5\u03AF\u03C7\u03B1\u03BD \u03B1\u03BD\u03B8\u03C1\u03CE\u03C0\u03B9\u03BD\u03BF \u03AC\u03BD\u03C9 \u03BA\u03BF\u03C1\u03BC\u03CC \u03BA\u03B1\u03B9 \u03B1\u03C0\u03CC \u03C4\u03B7 \u03BC\u03AD\u03C3\u03B7 \u03BA\u03B1\u03B9 \u03BA\u03AC\u03C4\u03C9 \u03BC\u03BF\u03C1\u03C6\u03AE \u03B1\u03BB\u03CC\u03B3\u03BF\u03C5 \u03AE\u03C4\u03B1\u03BD \u03BF\u03B9:");
	     lblNewLabel.setFont(new Font("Comic Sans MS", Font.PLAIN, 20));
	     lblNewLabel.setForeground(new Color(102, 102, 204));
	     lblNewLabel.setBounds(10, 109, 873, 70);
	     ...
	     next_btn.addMouseListener(new MouseAdapter() {
	     	...
	     	public void mouseClicked(MouseEvent e) {
				...
				if (btna.isSelected() || btnb.isSelected() || btnc.isSelected() || btnd.isSelected()) {
					dispose();
					Myth_fr3 frame1 = new Myth_fr3(scoreboardService, user);
