...
public class Cultu_fr10 extends ScoreboardJFrame {

	private JLabel lbl_q1;
	private JLabel lbl_question;
	private final static Integer qID = 9;
	...
	ButtonGroup bg;
	// apanthseis- sunolo 4//
	String ap1[] = { "\u{391}. \u{3A3}\u{3BF}\u{3C6}\u{3BF}\u{3BA}\u{3BB}\u{3AE}\u{3C2}" };
	String ap2[] = { "\u{392}. \u{391}\u{3B9}\u{3C3}\u{3C7}\u{3CD}\u{3BB}\u{3BF}\u{3C2}" };
	String ap3[] = { "\u{393}. \u{395}\u{3C5}\u{3C1}\u{3C5}\u{3C0}\u{3AF}\u{3B4}\u{3B7}\u{3C2}" }; /** swsto */
	...
	// public void run() {
	// try {
	// Cultu_fr10 frame = new Cultu_fr10();
	 ...
	 * Create the frame.
	 */
	public Cultu_fr10(ScoreboardService scoreboardService, User user) {
		...
		// Erwthsh//
		lbl_question = new JLabel("\u{3A0}\u{3BF}\u{3B9}\u{3BF}\u{3C2} \u{3AD}\u{3B3}\u{3C1}\u{3B1}\u{3C8}\u{3B5}
		\u{3C4}\u{3B7}\u{3BD}
		\u{AB}\u{399}\u{3C6}\u{3B9}\u{3B3}\u{3AD}\u{3BD}\u{3B5}\u{3B9}\u{3B1} \u{3B5}\u{3BD}
		\u{391}\u{3C5}\u{3BB}\u{3AF}\u{3B4}\u{3B9}\u{BB}");
		...
		next_btn.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (btna.isSelected() || btnb.isSelected() || btnc.isSelected() || btnd.isSelected()) {
					dispose();
					Cultu_final frame1 = new Cultu_final(scoreboardService, user);
