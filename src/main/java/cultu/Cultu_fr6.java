...
public class Cultu_fr6 extends ScoreboardJFrame {
	...
	ButtonGroup bg;
	// apanthseis- sunolo 4//
	String ap1[] = { "\u{391}. \u{3C4}\u{3B1} \u{3B3}\u{3B5}\u{3C9}\u{3BC}\u{3B5}\u{3C4}\u{3C1}\u{3B9}\u{3BA}\u{3AC}
	\u{3C7}\u{3C1}\u{3CC}\u{3BD}\u{3B9}\u{3B1}" };
	String ap2[] = { "\u{392}. \u{3C4}\u{3B7}\u{3BD} \u{3BA}\u{3BB}\u{3B1}\u{3C3}\u{3B9}\u{3BA}\u{3AE}
	\u{3B5}\u{3C0}\u{3BF}\u{3C7}\u{3AE}" };
	String ap3[] = { "\u{393}. \u{3C4}\u{3B7}\u{3BD} \u{3B5}\u{3C0}\u{3BF}\u{3C7}\u{3AE} \u{3C4}\u{3BF}\u{3C5}
	\u{3C7}\u{3B1}\u{3BB}\u{3BA}\u{3BF}\u{3CD}" }; /** swsto */
	...
	public Cultu_fr6(ScoreboardService scoreboardService, User user) {
		...
		// Erwthsh//
		lbl_question = new JLabel("\u{39F} \u{3BC}\u{3C5}\u{3BA}\u{3B7}\u{3BD}\u{3B1}\u{3CA}\u{3BA}\u{3CC}\u{3C2}
		\u{3C0}\u{3BF}\u{3BB}\u{3B9}\u{3C4}\u{3B9}\u{3C3}\u{3BC}\u{3CC}\u{3C2}
		\u{3B1}\u{3BD}\u{3B1}\u{3C0}\u{3C4}\u{3CD}\u{3C7}\u{3B8}\u{3B7}\u{3BA}\u{3B5}:");
