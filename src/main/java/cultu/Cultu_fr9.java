...
public class Cultu_fr9 extends ScoreboardJFrame {

	private JLabel lbl_q1;
	private JLabel lbl_question;
	private final static Integer qID = 8;
	...
	ButtonGroup bg;
	// apanthseis- sunolo 4//
	String ap1[] = { "\u{391}. \u{394}\u{3C9}\u{3C1}\u{3B9}\u{3BA}\u{3BF}\u{3CD}" }; /** swsto */
	String ap2[] = { "\u{392}. \u{399}\u{3C9}\u{3BD}\u{3B9}\u{3BA}\u{3BF}\u{3CD}" };
	String ap3[] = { "\u{392}. \u{399}\u{3C9}\u{3BD}\u{3B9}\u{3BA}\u{3BF}\u{3CD}" };
	 ...
	 * Create the frame.
	 */
	public Cultu_fr9(ScoreboardService scoreboardService, User user) {
		...
		// Erwthsh//
		lbl_question = new JLabel("\u{3A4}\u{3B9} \u{3C1}\u{3C5}\u{3B8}\u{3BC}\u{3BF}\u{3CD}
		\u{3B5}\u{3AF}\u{3BD}\u{3B1}\u{3B9} \u{3BF} \u{3BD}\u{3B1}\u{3CC}\u{3C2}
		\u{3C4}\u{3BF}\u{3C5} \u{397}\u{3C6}\u{3B1}\u{3AF}\u{3C3}\u{3C4}\u{3BF}\u{3C5}");
		...
		next_btn.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (btna.isSelected() || btnb.isSelected() || btnc.isSelected() || btnd.isSelected()) {
					dispose();
					Cultu_fr10 frame1 = new Cultu_fr10(scoreboardService, user);
