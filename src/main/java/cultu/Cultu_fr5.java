...
public class Cultu_fr5 extends ScoreboardJFrame {

	private JLabel lbl_q1;
	private JLabel lbl_question;
	private final static Integer qID = 4;
	...
	ButtonGroup bg;
	// apanthseis- sunolo 4//
	String ap1[] = { "\u{391}. \u{3C4}\u{3B1} \u{3BA}\u{3C1}\u{3B7}\u{3C4}\u{3B9}\u{3BA}\u{3AC}
	\u{3B9}\u{3B5}\u{3C1}\u{3BF}\u{3B3}\u{3BB}\u{3C5}\u{3C6}\u{3B9}\u{3BA}\u{3AC}" };
	String ap2[] = { "\u{392}. \u{3B7} \u{393}\u{3C1}\u{3B1}\u{3BC}\u{3BC}\u{3B9}\u{3BA}\u{3AE} \u{392}" }; /** swsto */
	String ap3[] = { "\u{393}. \u{3B7} \u{393}\u{3C1}\u{3B1}\u{3BC}\u{3BC}\u{3B9}\u{3BA}\u{3AE} \u{391}" };
	 ...
	 * Create the frame.
	 */
	public Cultu_fr5(ScoreboardService scoreboardService, User user) {
		...
		next_btn.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (btna.isSelected() || btnb.isSelected() || btnc.isSelected() || btnd.isSelected()) {
					dispose();
					Cultu_fr6 frame1 = new Cultu_fr6(scoreboardService, user);
