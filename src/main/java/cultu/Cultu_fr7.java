...
public class Cultu_fr7 extends ScoreboardJFrame {

	private JLabel lbl_q1;
	private JLabel lbl_question;
	private final static Integer qID = 6;
	...
	ButtonGroup bg;
	// apanthseis- sunolo 4//
	String ap1[] = { "\u{391}. \u{3BF}\u{3B9} \u{391}\u{3C5}\u{3BB}\u{3B9}\u{3BA}\u{3BF}\u{3AF}" };
	String ap2[] = { "\u{392}. \u{3BF} \u{386}\u{3BD}\u{3B1}\u{3BE}" }; /** swsto */
	String ap3[] = { "\u{393}. \u{3C4}\u{3BF} \u{399}\u{3B5}\u{3C1}\u{3B1}\u{3C4}\u{3B5}\u{3AF}\u{3BF}" };
	 ...
	 * Create the frame.
	 */
	public Cultu_fr7(ScoreboardService scoreboardService, User user) {
		...
		// Erwthsh//
		lbl_question = new JLabel("\u{391}\u{3C5}\u{3C3}\u{3C4}\u{3B7}\u{3C1}\u{3AC}
		\u{3B9}\u{3B5}\u{3C1}\u{3B1}\u{3C1}\u{3C7}\u{3B7}\u{3BC}\u{3AD}\u{3BD}\u{3B7} \u{3B7}
		\u{3BC}\u{3C5}\u{3BA}\u{3B7}\u{3BD}\u{3B1}\u{3CA}\u{3BA}\u{3AE}
		\u{3BA}\u{3BF}\u{3B9}\u{3BD}\u{3C9}\u{3BD}\u{3AF}\u{3B1}
		\u{3B8}\u{3C5}\u{3BC}\u{3AF}\u{3B6}\u{3B5}\u{3B9} \u{3BC}\u{3B9}\u{3B1}
		\u{3C0}\u{3C5}\u{3C1}\u{3B1}\u{3BC}\u{3AF}\u{3B4}\u{3B1}, \u{3C3}\u{3C4}\u{3B7}\u{3BD}
		\u{3BA}\u{3BF}\u{3C1}\u{3C5}\u{3C6}\u{3AE} \u{3C4}\u{3B7}\u{3C2}
		\u{3BF}\u{3C0}\u{3BF}\u{3AF}\u{3B1}\u{3C2}
		\u{3B2}\u{3C1}\u{3B9}\u{3C3}\u{3BA}\u{3B5}\u{3C4}\u{3B1}\u{3B9}:");
		...
		next_btn.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (btna.isSelected() || btnb.isSelected() || btnc.isSelected() || btnd.isSelected()) {
					dispose();
					Cultu_fr8 frame1 = new Cultu_fr8(scoreboardService, user);
