...
public class Cultu_fr2 extends ScoreboardJFrame {

	private JLabel lbl_q1;
	private JLabel lbl_question;
	private final static Integer qID = 1;
	...
	ButtonGroup bg;
	// apanthseis- sunolo 4//
	String ap1[] = { "\u{39A}\u{3B1}\u{3BD}\u{3AD}\u{3BD}\u{3B1} \u{391}\u{3C0}\u{3CC} \u{3C4}\u{3B1} \u{3C0}\u{3B1}\u{3C1}\u{3B1}\u{3C0}\u{3AC}\u{3BD}\u{3C9}" };
	String ap2[] = { "\u{392}. \u{3C4}\u{3B7}\u{3BD}
	\u{397}\u{3C0}\u{3B5}\u{3B9}\u{3C1}\u{3C9}\u{3C4}\u{3B9}\u{3BA}\u{3AE}
	\u{395}\u{3BB}\u{3BB}\u{3AC}\u{3B4}\u{3B1}\n" }; /** swsto */
	String ap3[] = { "\u{393}. \u{3C4}\u{3B7}\u{3BD} \u{39A}\u{3C1}\u{3AE}\u{3C4}\u{3B7}\n\n" };
	 ...
	 * Create the frame.
	 */
	public Cultu_fr2(ScoreboardService scoreboardService, User user) {
		...
		// Erwthsh//
		lbl_question = new JLabel("\u{3A4}\u{3B7} 2\u{3B7} \u{3C7}\u{3B9}\u{3BB}\u{3B9}\u{3B5}\u{3C4}\u{3AF}\u{3B1}
		\u{3BF}\u{3B9} \u{39A}\u{3C5}\u{3BA}\u{3BB}\u{3AC}\u{3B4}\u{3B5}\u{3C2}
		\u{3AD}\u{3C7}\u{3BF}\u{3C5}\u{3BD} \u{3B5}\u{3C0}\u{3B1}\u{3C6}\u{3AD}\u{3C2}
		\u{3B1}\u{3C1}\u{3C7}\u{3B9}\u{3BA}\u{3AC} \u{3BC}\u{3B5}:");
		...
		next_btn.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (btna.isSelected() || btnb.isSelected() || btnc.isSelected() || btnd.isSelected()) {
					dispose();
					Cultu_fr3 frame1 = new Cultu_fr3(scoreboardService, user);
