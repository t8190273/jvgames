...
public class Cultu_fr8 extends ScoreboardJFrame {

	private JLabel lbl_q1;
	private JLabel lbl_question;
	private final static Integer qID = 7;
	...
	ButtonGroup bg;
	// apanthseis- sunolo 4//
	String ap1[] = { "\u{391}. \u{393}\u{3BB}\u{3CD}\u{3C0}\u{3C4}\u{3B7}\u{3C2}" };
	String ap2[] = { "\u{392}. \u{396}\u{3C9}\u{3B3}\u{3C1}\u{3AC}\u{3C6}\u{3BF}\u{3C2} " };
	String ap3[] = { "\u{393}. \u{3A3}\u{3C5}\u{3B3}\u{3B3}\u{3C1}\u{3B1}\u{3C6}\u{3AD}\u{3B1}\u{3C2}" }; /**swsto */
	 ...
	 * Create the frame.
	 */
	public Cultu_fr8(ScoreboardService scoreboardService, User user) {
		...
		// Erwthsh//
		lbl_question = new JLabel("\u{3A4}\u{3B9} \u{3AE}\u{3C4}\u{3B1}\u{3BD} \u{3BF}
		\u{395}\u{3CD}\u{3C0}\u{3BF}\u{3BB}\u{3B9}\u{3C2}");
		...
		next_btn.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (btna.isSelected() || btnb.isSelected() || btnc.isSelected() || btnd.isSelected()) {
					dispose();
					Cultu_fr9 frame1 = new Cultu_fr9(scoreboardService, user);
