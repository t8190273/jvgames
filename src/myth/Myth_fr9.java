...
public class Myth_fr9 extends ScoreboardJFrame {

	private JLabel lbl_q1;
    private JLabel lblNewLabel;
	private final static Integer qID = 38;
...
//	}
	 ...
	 * Create the frame.
	 */
	public Myth_fr9(ScoreboardService scoreboardService, User user) {
		...
		//ButtonGroup Initialization//
	     ...
	     lblNewLabel = new JLabel("\u03A0\u03BF\u03B9\u03BF \u03BC\u03C5\u03B8\u03B9\u03BA\u03CC \u03C0\u03BB\u03AC\u03C3\u03BC\u03B1 \u03C6\u03C5\u03BB\u03BF\u03CD\u03C3\u03B5 \u03C4\u03B9\u03C2 \u03C0\u03CD\u03BB\u03B5\u03C2 \u03C4\u03BF\u03C5 \u0386\u03B4\u03B7;");
	     ...
	     next_btn.addMouseListener(new MouseAdapter() {
	     	...
	     	public void mouseClicked(MouseEvent e) {
				...
				if (btna.isSelected() || btnb.isSelected() || btnc.isSelected() || btnd.isSelected()) {
					dispose();
					Myth_fr10 frame1 = new Myth_fr10(scoreboardService, user);
