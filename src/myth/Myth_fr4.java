...
public class Myth_fr4 extends ScoreboardJFrame {

	private JLabel lbl_q1;
    private JLabel lblNewLabel;
	private final static Integer qID = 33;
	...
	//radio btn//
		...
		ButtonGroup bg;
		//apanthseis- sunolo 4//
		String ap1[] = {"\u03B1) \u0391\u03C1\u03B9\u03AC\u03B4\u03BD\u03B7"};
	    String ap2[] = {"\u03B2) \u03A6\u03B1\u03AF\u03B4\u03C1\u03B1"};
	    String ap3[] = {"\u03B3) \u0391\u03BD\u03C4\u03B9\u03CC\u03C0\u03B7"};
	    String ap4[] = {"\u03B4) \u0399\u03C6\u03B9\u03B3\u03AD\u03BD\u03B5\u03B9\u03B1 "}; /*Swsto*/
...
//	}
	 ...
	 * Create the frame.
	 */
	public Myth_fr4(ScoreboardService scoreboardService, User user) {
		...
		//ButtonGroup Initialization//
	     ...
	     lblNewLabel = new JLabel("\u03A0\u03BF\u03B9\u03AC \u03BB\u03C5\u03C0\u03AE\u03B8\u03B7\u03BA\u03B5 \u03C4\u03B5\u03BB\u03B5\u03C5\u03C4\u03B1\u03AF\u03B1 \u03C3\u03C4\u03B9\u03B3\u03BC\u03AE \u03B7 \u03B8\u03B5\u03AC \u0386\u03C1\u03C4\u03B5\u03BC\u03B9\u03C2 \u03BA\u03B1\u03B9 \u03AD\u03B2\u03B1\u03BB\u03B5 \u03C0\u03C1\u03B9\u03BD \u03C4\u03B7 \u03B8\u03C5\u03C3\u03AF\u03B1 \u03C3\u03C4\u03B7 \u03B8\u03AD\u03C3\u03B7 \u03C4\u03B7\u03C2;");
	     lblNewLabel.setFont(new Font("Comic Sans MS", Font.PLAIN, 21));
	     lblNewLabel.setForeground(new Color(102, 102, 204));
	     lblNewLabel.setBounds(36, 109, 847, 70);
	     ...
	     next_btn.addMouseListener(new MouseAdapter() {
	     	...
	     	public void mouseClicked(MouseEvent e) {
				...
				if (btna.isSelected() || btnb.isSelected() || btnc.isSelected() || btnd.isSelected()) {
					dispose();
					Myth_fr5 frame1 = new Myth_fr5(scoreboardService, user);
