...
public class Myth_fr6 extends ScoreboardJFrame {

	private JLabel lbl_q1;
    private JLabel lblNewLabel;
	private final static Integer qID = 35;
...
//	}
	 ...
	 * Create the frame.
	 */
	public Myth_fr6(ScoreboardService scoreboardService, User user) {
	     ...
	     next_btn.addMouseListener(new MouseAdapter() {
	     	...
	     	public void mouseClicked(MouseEvent e) {
				...
				if (btna.isSelected() || btnb.isSelected() || btnc.isSelected() || btnd.isSelected()) {
					dispose();
					Myth_fr7 frame1 = new Myth_fr7(scoreboardService, user);
