...
public class Myth_fr7 extends ScoreboardJFrame {

	private JLabel lbl_q1;
    private JLabel lblNewLabel;
	private final static Integer qID = 36;
	...
	//radio btn//
		...
		ButtonGroup bg;
		//apanthseis- sunolo 4//
		String ap1[] = {"\u03B1) \u0391\u03C0\u03CC\u03BB\u03BB\u03C9\u03BD\u03B1"};
	    String ap2[] = {"\u03B2) \u0397\u03C6\u03B1\u03AF\u03C3\u03C4\u03BF\u03C5"};
	    String ap3[] = {"\u03B3) \u0395\u03C1\u03BC\u03AE"}; /*Swsto*/
	    String ap4[] = {"\u03B4) \u0394\u03AF\u03B1"};
...
//	}
	 ...
	 * Create the frame.
	 */
	public Myth_fr7(ScoreboardService scoreboardService, User user) {
		...
		//ButtonGroup Initialization//
	     ...
	     lblNewLabel = new JLabel("\u039F \u0395\u03C1\u03BC\u03B1\u03C6\u03C1\u03CC\u03B4\u03B9\u03C4\u03BF\u03C2 \u03AE\u03C4\u03B1\u03BD \u03B3\u03B9\u03CC\u03C2 \u03C4\u03B7\u03C2 \u0391\u03C6\u03C1\u03BF\u03B4\u03AF\u03C4\u03B7\u03C2 \u03BA\u03B1\u03B9 \u03C4\u03BF\u03C5 \u03B8\u03B5\u03BF\u03CD :");
	     ...
	     next_btn.addMouseListener(new MouseAdapter() {
	     	...
	     	public void mouseClicked(MouseEvent e) {
				...
				if (btna.isSelected() || btnb.isSelected() || btnc.isSelected() || btnd.isSelected()) {
					dispose();
					Myth_fr8 frame1 = new Myth_fr8(scoreboardService, user);
